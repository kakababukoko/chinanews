            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        ...
                        <li><a href="javascript: void(0);">Inactive</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="layouts-dark-sidebar.html">Logo</a></li>
                        <li><a href="layouts-compact-sidebar.html">Mobile Number</a></li>
                        <li><a href="layouts-dark-sidebar.html">Social</a></li>
